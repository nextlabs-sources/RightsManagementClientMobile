 ...
 * @return A NXInputModel for a match (typically the first item in the matching results),
 * or nil if the text shouldn't be accepted.
 */
- (nullable NXInputModel *)tokenInputView:(CLTokenInputView *)view tokenForText:(NSString *)text;
/**
...
@property (readonly, nonatomic) CL_GENERIC_ARRAY(NXInputModel *) *allTokens;
