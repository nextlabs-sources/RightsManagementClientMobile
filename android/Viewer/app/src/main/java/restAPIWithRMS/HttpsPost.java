...
/**
 * this class is designed to support basic https post request,as client side
 */
public class HttpsPost {
    ...
    static public InputStream sendRequest(URL url, Map<String, String> headInfo, String postInfo, Listener listener) throws Exception {
        ...
        // add header
        // add default header
        conn.addRequestProperty("User-Agent", "Osmond's robot");
        ...
        if (conn.getResponseCode() != HttpURLConnection.HTTP_OK) {
            throw new RuntimeException("POST request not worked" + "-" + String.valueOf(conn.getResponseCode()));
        }
