...
public class MuPDFActivity /*extends Activity*/ implements FilePicker.FilePickerSupport {
    ...
    private ITitleEvent mCallBack;

    public MuPDFActivity(ITitleEvent CallBack) {
        mCallBack = CallBack;
    }
        ...
        mAlertTask = new AsyncTask<Void, Void, MuPDFAlert>() {
            ...
            protected void onPostExecute(final MuPDFAlert result) {
                ...
                switch (result.buttonGroupType) {
                    case OkCancel:
                        mAlertDialog.setButton(AlertDialog.BUTTON2, mactivity.getString(R.string.cancel), listener);
                        pressed[1] = MuPDFAlert.ButtonPressed.Cancel;
                    case Ok:
                        mAlertDialog.setButton(AlertDialog.BUTTON1, mactivity.getString(R.string.okay), listener);
                        pressed[0] = MuPDFAlert.ButtonPressed.Ok;
                        break;
                    case YesNoCancel:
                        mAlertDialog.setButton(AlertDialog.BUTTON3, mactivity.getString(R.string.cancel), listener);
                        pressed[2] = MuPDFAlert.ButtonPressed.Cancel;
                    case YesNo:
                        mAlertDialog.setButton(AlertDialog.BUTTON1, mactivity.getString(R.string.yes), listener);
                        pressed[0] = MuPDFAlert.ButtonPressed.Yes;
                        mAlertDialog.setButton(AlertDialog.BUTTON2, mactivity.getString(R.string.no), listener);
    ...
    private MuPDFCore openBuffer(byte buffer[], String magic) {
        ...
        try {
            core = new MuPDFCore(mactivity, buffer, magic);
            // New file: drop the old outline data
            OutlineActivityData.set(null);
        } catch (Exception e) {
            System.out.println(e);
     ...
     */
    public void onCreate(final Bundle savedInstanceState, Activity activity, String action, Uri uri) {
        ...
        if (core == null) {
            core = (MuPDFCore) mactivity.getLastNonConfigurationInstance();
            ...
            if (Intent.ACTION_VIEW.equals(action)) {
                ...
                if (uri.toString().startsWith("content://")) {
                    ...
                    try {
                        ...
                        try {
                            Cursor cursor = mactivity.getContentResolver().query(uri, new String[]{"_data"}, null, null, null);
                    ...
                    if (reason != null) {
                        ...
                        mactivity.setTitle(String.format(res.getString(R.string.cannot_open_document_Reason), reason));
                        alert.setButton(AlertDialog.BUTTON_POSITIVE, mactivity.getString(R.string.dismiss),
    ...
    public void requestPassword(final Bundle savedInstanceState) {
        ...
        alert.setButton(AlertDialog.BUTTON_POSITIVE, mactivity.getString(R.string.okay),
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
        ...
        alert.setButton(AlertDialog.BUTTON_NEGATIVE, mactivity.getString(R.string.cancel),
                new DialogInterface.OnClickListener() {
    ...
    public void createUI(Bundle savedInstanceState) {
        ...
        mDocView = new MuPDFReaderView(mactivity) {
            @Override
        ...
        mDocView.setAdapter(new MuPDFPageAdapter(mactivity, this, core));

        mSearchTask = new SearchTask(mactivity, core) {
            @Override
            ...
            mOutlineButton.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    if (outline != null) {
                        ...
                        Intent intent = new Intent(mactivity, OutlineActivity.class);
                        mactivity.startActivityForResult(intent, OUTLINE_REQUEST);
                    }
                }
            });
        } else {
        ...
        if (isProofing()) {
            ...
            int currentPage = mactivity.getIntent().getIntExtra("startingPage", 0);
    ...
    private void reflowModeSet(boolean reflow) {
        mReflow = reflow;
        mDocView.setAdapter(mReflow ? new MuPDFReflowAdapter(mactivity, core) : new MuPDFPageAdapter(mactivity, this, core));
...
/*	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case PRINT_REQUEST:
			if (resultCode == mactivity.RESULT_CANCELED)
				showInfo(mactivity.getString(R.string.print_failed));
			break;
		case FILEPICK_REQUEST:
			if (mFilePicker != null && resultCode == mactivity.RESULT_OK)
    ...
    private void toggleReflow() {
        ...
        showInfo(mReflow ? mactivity.getString(R.string.entering_reflow_mode) : mactivity.getString(R.string.leaving_reflow_mode));
    }
    ...
    private void printDoc() {
        /*if (!core.fileFormat().startsWith("PDF")) {
            showInfo(mactivity.getString(R.string.format_currently_not_supported));
			return;
		}
    ...
    private void showInfo(String message) {
        ...
        if (currentApiVersion >= android.os.Build.VERSION_CODES.HONEYCOMB) {
            SafeAnimatorInflater safe = new SafeAnimatorInflater((Activity) mactivity, R.animator.info, (View) mInfoView);
        } else {
    ...
    private void makeButtonsView() {
        mButtonsView = mactivity.getLayoutInflater().inflate(R.layout.buttons, null);
    ...
    public void proofWithResolution(int resolution) {
        ...
        Intent intent = new Intent(mactivity, MuPDFActivity.class);
...
//					break;
    ...
    public void OnCopyTextButtonClick(View v) {
        ...
        mAnnotTypeText.setText(mactivity.getString(R.string.copy_text));
        showInfo(mactivity.getString(R.string.select_text));
    }
    ...
    public void OnInkButtonClick(View v) {
        ...
        showInfo(mactivity.getString(R.string.draw_annotation));
    }
    ...
    public void OnAcceptButtonClick(View v) {
        ...
        switch (mAcceptMode) {
            case CopyText:
                ...
                mTopBarMode = TopBarMode.More;
                showInfo(success ? mactivity.getString(R.string.copied_to_clipboard) : mactivity.getString(R.string.no_text_selected));
                break;
            ...
            case Highlight:
                ...
                mTopBarMode = TopBarMode.Annot;
                if (!success)
                    showInfo(mactivity.getString(R.string.no_text_selected));
                break;
            ...
            case Ink:
                ...
                mTopBarMode = TopBarMode.Annot;
                if (!success)
                    showInfo(mactivity.getString(R.string.nothing_to_save));
                break;
        }
        mTopBarSwitcher.setDisplayedChild(mTopBarMode.ordinal());
        mDocView.setMode(MuPDFReaderView.Mode.Viewing);
    ...
    public void onBackPressed() {
        if (core != null && core.hasChanges()) {
            ...
            AlertDialog alert = mAlertBuilder.create();
            alert.setTitle(R.string.title_popup_dialog);
            alert.setMessage(mactivity.getString(R.string.document_has_changes_save_them_));
            alert.setButton(AlertDialog.BUTTON_POSITIVE, mactivity.getString(R.string.yes), listener);
            alert.setButton(AlertDialog.BUTTON_NEGATIVE, mactivity.getString(R.string.no), listener);
            alert.show();
        } else {
    ...
    public void performPickFor(FilePicker picker) {
        mFilePicker = picker;
        Intent intent = new Intent(mactivity, ChoosePDFActivity.class);
