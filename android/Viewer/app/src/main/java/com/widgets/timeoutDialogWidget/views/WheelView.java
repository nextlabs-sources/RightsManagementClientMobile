...
import com.widgets.timeoutDialogWidget.adapter.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    private void initResourcesIfNecessary() {
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.bg_timeout_wheel_value);
        }
        ...
        setBackgroundResource(R.drawable.bg_timeout_dialog_selector);
    }
    ...
    private int calculateLayoutWidth(int widthSize, int mode) {
        ...
        // TODO: make it static
        itemsLayout.setLayoutParams(new WindowManager.LayoutParams(WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.WRAP_CONTENT));
